    ...
    <table>
      ...
      <tbody>
        <tr v-for="aution in autionList" :key="aution.id">
          ...
          <td>
            <router-link
              :to="{ name: 'aution-detail', params: { autionId: aution.id}}"
            >{{aution.title}}</router-link>
          </td>
    ...
    <b-row class="b-row">
      ...
      <b-col class="b-row">
        <div>
          ...
          <b-form-input id="ownerName" v-model="name" placeholder="your name" />
        </div>
        <div>
          <label for="phoneNumber">phone number</label>
          <b-form-input id="phoneNumber" v-model="phoneNumber" placeholder="your phone number" />
        </div>
        <div>
          <label for="address">Address</label>
          <b-form-input id="address" v-model="address" placeholder="your address" />
        </div>
      </b-col>
    </b-row>
